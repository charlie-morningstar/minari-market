...
# 7. 체크리스트 · 테스트 · 문서 (보고서/그림은 제출 PDF 로 따로 → 저장소 제외)
git add README.md docs/보안_체크리스트.md docs/테스트_결과.md \
        tests/security_test.py run.sh setup_git.sh
commit "2026-07-23T13:30:00" "보안 체크리스트/자동 점검 스크립트/README/실행 스크립트 작성"
